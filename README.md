...
- `Повторы отправки при сбоях сети`: число дополнительных попыток при сетевых ошибках с нарастающими паузами (1с → 2с → 4с…, максимум 60с), по умолчанию `3`, диапазон 0–10, `0` отключает повторы
